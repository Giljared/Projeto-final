...
const tutoriais = [
    ...
    {
        id: 5,
        nome: "Como dar aula Online rápida, simples e descomplicada usando o WhatsApp e Google Drive",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwnjC8DetlGAoTScQtme_2fkR-8ES8bAEkfI9P3LqNA=s176-c-k-c0x00ffffff-no-rj",
        descricao: "E se você é professor ou profissional liberal e está aprendendo a usar a tecnologia para dar aulas simples, rápida e descomplicada, vai querer assistir até o final. Então aproveite e use e abuse do WhatsApp e Google Drive e ainda se preferir entre para o grupo de mentoria onde mais profissionais assim como você estão aprendendo a fazer isso.",
        link: "https://www.youtube.com/watch?v=I5_8xdNSu28&ab_channel=DanielaBurkhard"
    },
    {
        id: 6,
    ...
    {
        id: 8,
        nome: "Google Classroom - Tutorial básico para Professores",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwng4VuUEJi3YHTPWYHBPc35bCkzCLEgRRPpGY-jaTw=s176-c-k-c0x00ffffff-no-rj",
        descricao: "Nesse breve tutorial, eu ensino as funcionalidades básicas da plataforma de salas de aula virtuais do Google. É uma ferramenta que pode engrandecer a interação entre professores e alunos e facilitar a vida de ambos.",
        link: "https://www.youtube.com/watch?v=zcgTgrTfKU8&ab_channel=FelipeMagalh%C3%A3es" 
    },
    {
        id: 9,
    ...
    {
        id: 10,
        nome: "Tutorial para Professores - Como utilizar o Google Meet",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwnhjz13DaPowMIPK0UV2BvdfEqyiNqCpBKAJWTHu2A=s176-c-k-c0x00ffffff-no-rj",
        descricao: "Tutorial para Professores sobre como utilizar o Google Meet dentro do Google Classroom, para as aulas on-line. - Como habilitar o Google Meet dentro do Classroom - Como criar um Meet (Reunião / Aula on-line) - Como agendar um Meet (Reunião / Aula on-line) - Conhecendo a interface do Google Meet.",
        link: "https://www.youtube.com/watch?v=ira_4Y6Nyu8&ab_channel=MarceloGasparin"
    },
    {
        id: 11,
        nome: "GOOGLE MEET - Como apresentar SLIDES (PPT), ver CHAT e IMAGENS dos participantes ao mesmo tempo",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwnjKj4eAtEOhHlOHRukw31OmbmlEomZNjUn_EGoYORI=s176-c-k-c0x00ffffff-no-rj",
        descricao: "Você precisa fazer uma apresentação de slides numa reunião pelo GOOGLE MEET e ele toma todo o espaço da tela, impedindo você de acompanhar o chat? Veja uma maneira simples para evitar que isso aconteça! Neste vídeo, compartilho com você uma maneira bem fácil de apresentar o slide e ter acesso ao chat no GOOGLE MEET ao mesmo tempo.",
        link: "https://www.youtube.com/watch?v=z7Shc3OCCds&ab_channel=SorayaRoque"
    },
    {
        id: 12,
    ...
    {
        id: 17,
        nome: "Atividades interativas digitais: elas podem ser feitas on line (ótima dica para as aulas remotas)",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwniuIOLmW4I_2-uTTZBuRC3X1cuXxLgR2K_HIdKLew=s176-c-k-c0x00ffffff-no-rj",
        descricao: "Sobre esse vídeo que você acabou de assistir: Apresento as atividades interativas digitais do site : 'liveworksheet'. Mostro como encontrar e enviar para os alunos. Uma ótima atividade para o ensino remoto e depois também.",
        link: "https://www.youtube.com/watch?v=s62j1gjAQcQ&ab_channel=PriGeo"
    },
    {
        id: 18,
        nome: "Como criar jogos educativos on line (sugestão para aulas remotas)",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwniuIOLmW4I_2-uTTZBuRC3X1cuXxLgR2K_HIdKLew=s176-c-k-c0x00ffffff-no-rj",
        descricao: "Nesse vídeo ensino a criar mais de 5 jogos digitais de uma forma bem simples e rápida. Os jogos são criados e jogados on line (o aluno pode jogar com o celular e não precisa baixar aplicativo nenhum). É só copiar a URL do jogo criado e enviar para os alunos. Vamos lá, crie seus joguinhos personalizados e surpreenda seus alunos.",
        link: "https://www.youtube.com/watch?v=o2rmtGlN2Vg&t=2s&ab_channel=PriGeo"
    },
    {
        id: 19,
        nome: "Como fazer slides animados com o PowerPoint para suas aulas/apresentações de trabalho",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwniuIOLmW4I_2-uTTZBuRC3X1cuXxLgR2K_HIdKLew=s176-c-k-c0x00ffffff-no-rj",
        descricao: "Nesse vídeo explico como criar slides animados no Powerpoint, tando para as suas videoaulas, como para apresentação de trabalhos. Um vídeo para professores e estudantes. Esse é o primeiro vídeo de uma série de 3, onde irei apresentar segredos úteis do PowerPoint.",
        link: "https://www.youtube.com/watch?v=C9NxuX_7mhI&ab_channel=PriGeo"
    },
    {
        id: 20,
    ...
    {
        id: 23,
        nome: "Tutorial Google Forms: crie suas provas com correção automática e ganhe tempo!",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwnhuaRv2jWAZbDfuY36LhpSts4xXX_HtlUe2UpB7=s176-c-k-c0x00ffffff-no-rj",
        descricao: "Por acaso você passou os últimos finais de semana ou até noites em claro corrigindo pilhas de provas dos seus alunos? E se eu te disser que você pode reduzir essa carga extra de trabalho utilizando uma ferramenta gratuita e muito fácil de ser aplicada? Acesse o nosso tutorial que ensina exatamente como fazer isso! Deixe nos comentários o que você achou dessa ideia de automatizar sua correção! E aproveite pra compartilhar para outros professores e a sua coordenadora!",
        link: "https://www.youtube.com/watch?v=1TXKbzoHnPE&ab_channel=Prof.EderBento"
    },
    {
        id: 24,
        nome: "Como fazer uma atividade com o google forms? I Você só dá aula?",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwnjH5ypGDKOsY573MzmqVUwi_UmMdrzz2iL6zIbYZQ=s176-c-k-c0x00ffffff-no-rj",
        descricao: "O google forms (google formulário) é uma ótima ferramenta para você utilizar com seus alunos. Nesse vídeo eu te mostro um passo a passo de como montar uma atividade ou uma prova utilizando o google forms. Nesse processo, te dou várias dicas de como você pode utilizar e adaptar esse recurso para seu contexto.",
        link: "https://www.youtube.com/watch?v=mcRb4-wmCMU&ab_channel=Voc%C3%AAs%C3%B3d%C3%A1aula%3F"
    },
    {
        id: 25,
        nome: "18 DICAS para gravar VIDEOAULAS pelo CELULAR // Iluminação, áudio, edição e MAIS",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwng7cZOtvMxunlBDydB2o9d-2gsscnINKm-SnX-58wE=s176-c-k-c0x00ffffff-no-rj",
        descricao: "É professora e está perdida em como melhorar as aulas gravadas para seus alunos? Usa seu celular como ferramenta? Não sabe o melhor ângulo, luz ou onde apoiar o celular? Esse vídeo vai te ajudar! Usei minha experiência de 5 anos aqui no YouTube e reuni várias dicas super simples pra te ajudar. Espero que vocês gostem!",
        link: "https://www.youtube.com/watch?v=C578lY0dVCY&ab_channel=ClaraBousada"
    },
    {
        id: 26,
        nome: "Gravar Videoaulas: os 2 melhores aplicativos",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwnjK-VSBYyQd2sPe-PfDlOhNfnchIC1F_TgqeSwW2A=s176-c-k-c0x00ffffff-no-rj",
        descricao: "No vídeo de hoje, vou te dar uma recomendação de aplicativos para gravar videoaulas. Muitas pessoas me pedem essas sugestões, e hoje vou registrar isso em vídeo. Então, aproveite essas dicas e não perca mais tempo usando softwares que te deixam na mão quando você mais precisa.",
        link: "https://www.youtube.com/watch?v=_QTNVYx--J0&ab_channel=LucianoLarrossa"
    },
    {
        id: 27,
        nome: "Como gravar videoaula direto no PowerPoint sem precisar de gravador de tela",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwniuIOLmW4I_2-uTTZBuRC3X1cuXxLgR2K_HIdKLew=s176-c-k-c0x00ffffff-no-rj",
        descricao: "Olá, nesse vídeo apresento como gravar sua videoaula diretamente no PowerPoint. Você não vai precisar de gravador de tela. Além de gravar, você consegue editar no Powerpoint de maneira bem simples. Esse é o terceiro tutorial de uma série de 3: Segredos do PowerPoint. Estou usando a versão 2019 do programa.",
        link: "https://www.youtube.com/watch?v=oqDlDhnGx84&ab_channel=PriGeo"
    },
    {
        id: 28,
    ...
    {
        id: 29,
        nome: "Como gravar videoaula com celular",
        genero: "Educação",
        img: "https://yt3.ggpht.com/ytc/AAUvwngDJeuom5_yARJQCgYlZk6QzzhELaqnp8NrPCjQgrI=s176-c-k-c0x00ffffff-no-rj",
        descricao: "Neste video eu dou algumas dicas simples de como gravar uma videoaula com o seu celular na sua casa, sem uso de nenhum equipamento! Nestes tempos de Coronavírus a necessidade de Home Office nos obriga a improvisar soluções.",
        link: "https://www.youtube.com/watch?v=9aMfGEp8Nb0&ab_channel=SOMCAST"
    },
    {
        id: 30,
